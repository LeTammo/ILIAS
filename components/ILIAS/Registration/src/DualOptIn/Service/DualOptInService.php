...
class DualOptInService implements DualOptInServiceInterface
{
    public const string ID = "reg_hash_service";
    protected readonly Container $dic;
    protected readonly RegistrationHashRepository $reg_hash_repository;

    public function __construct(Container $dic)
    {
        $this->dic = $dic;
        $this->reg_hash_repository = new RegistrationHashRepository($this->dic->database(), new ClockFactoryImpl());
    }
